                        ...
                        try {
                            ...
                            for(i=0; i<findUseLastList.size(); i++) {
                                ...
                                for(int j=1; j<2; j++){
                                    ...
                                    findDateText.setId(160+j);
                                    findDateText.setText(findUseLastList.get(0).toString());
                                    ...
                                    findChainText.setId(10+j);
                                    findChainText.setText(findUseLastList.get(1).toString());
                                    ...
                                    findMenuText.setId(60+j);
                                    findMenuText.setText(findUseLastList.get(2).toString());
                                    ...
                                    findPriceText.setId(110+j);
                                    findPriceText.setText(findUseLastList.get(3).toString());
